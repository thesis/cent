...
export const currencies: Record<string, Currency> = {
  AFN, ALL, DZD, AOA, ARS, AMD, AWG, AUD, AZN, BHD, BDT, BBD, BYN, BZD, BMD,
  BTN, BOB, BAM, BWP, BRL, BND, BGN, BIF, CVE, KHR, CAD, KYD, XAF, XPF, CLP,
  CNY, COP, KMF, CDF, CRC, HRK, CUP, CZK, DKK, DJF, DOP, XCD, EGP, ERN, SZL,
  ETB, EUR, FKP, FJD, GMD, GEL, GHS, GIP, GTQ, GNF, GYD, HTG, HNL, HKD, HUF,
  ISK, INR, IDR, IRR, IQD, ILS, JMD, JPY, JOD, KZT, KES, KPW, KRW, KWD, KGS,
  LAK, LBP, LSL, LRD, LYD, MOP, MKD, MGA, MWK, MYR, MVR, MRU, MUR, MXN, MDL,
  MNT, MAD, MZN, MMK, NAD, NPR, ANG, NZD, NIO, NGN, NOK, OMR, PKR, PAB, PGK,
  PYG, PEN, PHP, PLN, QAR, RON, RUB, RWF, SHP, WST, STN, SAR, RSD, SCR, SLE,
  SGD, SBD, SOS, ZAR, SSP, LKR, SDG, SRD, SEK, CHF, SYP, TWD, TJS, TZS, THB,
  TOP, TTD, TND, TRY, TMT, UGX, UAH, AED, GBP, USD, UYU, UZS, VUV, VES, VND,
  XOF, YER, ZMW, ZWL, BTC, ETH, SOL
}
