...
describe('ExchangeRate', () => {
  ...
  describe('real-world exchange rate scenarios', () => {
    it('should handle USD/EUR exchange rate', () => {
      // 1 USD = 0.85 EUR
      const usdBase: AssetAmount = { asset: usdCurrency, amount: { amount: 100n, decimals: 2n } }    // $1.00
      const eurQuote: AssetAmount = { asset: eurCurrency, amount: { amount: 85n, decimals: 2n } }    // €0.85
    ...
    it('should handle BTC/USD exchange rate', () => {
      // 1 BTC = $50,000 USD
      const btcBase: AssetAmount = { asset: btcCurrency, amount: { amount: 100000000n, decimals: 8n } }  // 1.00000000 BTC
      const usdQuote: AssetAmount = { asset: usdCurrency, amount: { amount: 5000000n, decimals: 2n } }   // $50,000.00
