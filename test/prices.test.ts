...
import type { AssetAmount, Currency } from "../src/types"
...
describe("Price", () => {
  ...
  describe("divide", () => {
    ...
    it("should throw error when dividing by zero FixedPoint", () => {
      ...
      expect(() => price.divide(zeroFixedPoint)).toThrow(
  ...
  describe("Price-to-Price multiplication", () => {
    it("should multiply prices with shared assets (A/B * B/C = A/C)", () => {
      ...
      // 10000 apples / 1 BTC
      const applesPerBtc = new Price(applesAmount, btcAmount)
    ...
    it("should multiply prices with shared assets (A/B * C/A = C/B)", () => {
      // 1 BTC / $50,000
      const btcPerUsd = new Price(btcAmount, {
        asset: usdCurrency,
    ...
    it("should throw error when multiplying prices without shared assets", () => {
      ...
      const orangesPerBtc = new Price(orangeAmount, btcAmount)
