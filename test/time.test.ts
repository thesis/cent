...
describe("UNIXTime utilities", () => {
  describe("UNIXTimeSchema", () => {
    ...
    it("should reject non-string inputs", () => {
      const invalidInputs = [1640995200, null, undefined, {}, []]
    ...
    it("should reject non-numeric strings", () => {
      const invalidTimestamps = ["abc", "123.456", "123e4", "12 34", ""]
  ...
  describe("unixTimeToDate", () => {
    ...
    it("should round-trip correctly with dateToUNIXTime", () => {
      ...
      expect(Math.floor(restoredDateSec.getTime() / 1000)).toBe(
...
describe("UTCTime utilities", () => {
  describe("UTCTimeSchema", () => {
    ...
    it("should reject non-string inputs", () => {
      const invalidInputs = [1640995200000, null, undefined, {}, [], new Date()]
  ...
  describe("toUTCTime", () => {
    ...
    it("should throw error for invalid timestamps", () => {
      ...
      expect(() => toUTCTime("2022-01-01 00:00:00")).toThrow(
        "Invalid UTC timestamp",
      )
      expect(() => toUTCTime("")).toThrow("Invalid UTC timestamp")
      expect(() => toUTCTime("2022-02-30T00:00:00Z")).toThrow(
        "Invalid UTC timestamp",
      )
    })
  })
